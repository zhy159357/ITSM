 ...
 */
@Controller
@RequestMapping("cmdb/dj")
public class CmDbRecoveryRegisterController extends BaseController
{
    private String prefix = "cmdb/dj";
     ...
     * 新增保存【数据库恢复登记表】
     */
    @Log(title = "【数据库恢复登记】", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(CmDbRecoveryRegister cmDbRecoveryRegister)
    {
        //UUID
        ...
        return toAjax(cmDbRecoveryRegisterService.insertCmDbRecoveryRegister(cmDbRecoveryRegister));
    }
     ...
     * 删除【数据库恢复登记表】
     */
    @Log(title = "【数据库恢复登记】", businessType = BusinessType.DELETE)
    @PostMapping( "/remove")
    @ResponseBody
    public AjaxResult remove(String ids)
    {
        return toAjax(cmDbRecoveryRegisterService.deleteCmDbRecoveryRegisterByIds(ids));
    }
