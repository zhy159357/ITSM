...
/**
 * 采购事项需求变更对象 purchase_project_demand_change
 * 
 * @author ruoyi
 * @date 2021-11-17
 */
public class PurchaseProjectDemandChange extends BaseEntity
{
    ...
    /** 审批状态，01-待审批；02-已审批 */
    @Excel(name = "审批状态", readConverterExp = "01=草稿,02=待审批,03=已审批,04=已退回")
    ...
    public String toString() {
        return "PurchaseProjectDemandChange{" +
                "changeId='" + changeId + '\'' +
                ", purchaseProjectType='" + purchaseProjectType + '\'' +
                ...
                ", techSubmitTime='" + techSubmitTime + '\'' +
                ", planSubmitTime='" + planSubmitTime + '\'' +
                ", implStartTime='" + implStartTime + '\'' +
                ", implEndTime='" + implEndTime + '\'' +
                ", contractSignTime='" + contractSignTime + '\'' +
                ", serviceProvideTime='" + serviceProvideTime + '\'' +
                ", purchaseEffectivePeriod='" + purchaseEffectivePeriod + '\'' +
                ", projectTotalAmount='" + projectTotalAmount + '\'' +
                ", payTotalAmount='" + payTotalAmount + '\'' +
                ", capitalImplSituation='" + capitalImplSituation + '\'' +
                ", demandDept='" + demandDept + '\'' +
                ", demandPerson='" + demandPerson + '\'' +
                ", adjustContent='" + adjustContent + '\'' +
                ", adjustReason='" + adjustReason + '\'' +
                ", formalSubmitTime='" + formalSubmitTime + '\'' +
                ", estimateContractSignTime='" + estimateContractSignTime + '\'' +
                ", purchaseOppositePerson='" + purchaseOppositePerson + '\'' +
                ", currentProgress='" + currentProgress + '\'' +
                ", riskWarning='" + riskWarning + '\'' +
                ", memo='" + memo + '\'' +
                ", purchaseApproveId='" + purchaseApproveId + '\'' +
                ", purchaseApproveName='" + purchaseApproveName + '\'' +
