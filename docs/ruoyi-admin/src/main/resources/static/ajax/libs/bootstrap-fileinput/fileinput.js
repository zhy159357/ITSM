...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                ...
                '    {progress}\n{indicator}\n{actions}\n' +
                '</div>';
            tActions = '<div class="file-actions kv-hidden">\n' +
            ...
            tIndicator = '<div class="file-upload-indicator kv-hidden" title="{indicatorTitle}">{indicator}</div>';
    ...
    $.fn.fileinput.defaults = {
        ...
        uploadIcon: '<i class="glyphicon glyphicon-folder-open"></i>&nbsp;',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgDuplicateFile: 'File "{name}" of same size "{size} KB" 已经上传，请不要重复上传.',
