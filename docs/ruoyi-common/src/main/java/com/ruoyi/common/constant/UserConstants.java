...
public class UserConstants
{
    ...
    /** 账号名称是否唯一的返回结果码 */
    public final static String ACCOUNT_NAME_UNIQUE = "0";
    public final static String ACCOUNT_NAME_NOT_UNIQUE = "1";
    ...
    /** 岗位id是否唯一的返回结果码 */
    public final static String POST_IDPOST_UNIQUE = "0";
    public final static String POST_IDPOST_NOT_UNIQUE = "1";
    ...
    public final static String TEL_NAME_OK = "0";
    public final static String TEL_NAME_UNIQUE = "1";
    public final static String TEL_SERVERIP_UNIQUE = "2";

    /**
     * 登录方式
     */
    public final static String LOGIN_FLAG_USERNAME = "0";
    public final static String LOGIN_FLAG_PHONE = "1";

    /**
     * 获取pd
     */
    public final static String GETPD = "getpd4";
}
