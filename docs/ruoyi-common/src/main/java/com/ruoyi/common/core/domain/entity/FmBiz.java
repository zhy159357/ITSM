 ...
 * @date 2020-12-23
 */
public class FmBiz extends BaseEntity {
    ...
    @Excel(name = "是否疑难", sort = 47, readConverterExp = "1=是,0=否")
    private String ifYn;
     ...
     * 处理方式
     */
    @Excel(name = "处理方式", sort = 16, readConverterExp = "01=正常处理,03=多方配合处理,04=数据变更处理,05=差错处理")
