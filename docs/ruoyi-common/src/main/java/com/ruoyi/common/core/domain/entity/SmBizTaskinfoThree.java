 ...
 * @date 2021-01-12
 */
public class SmBizTaskinfoThree implements Serializable
{
    ...
    @Excel(name = "实施结果",sort = 6,readConverterExp = "0=实施成功,1=回退,2=实施后引入问题")
    private String performResult;

    @Excel(name = "变更计划时间",sort = 7)
    private String expectStartTime;

    @Excel(name = "变更实施时间",sort = 8)
    private String practicleEnd;

    @Excel(name = "实施人",sort = 9)
    ...
    @Excel(name = "填报时间",sort = 11)
    private String workEndTime;//处理结束时间

    @Excel(name = "变更单号",sort = 4)
    ...
    @Excel(name = "执行工作组",sort = 3)
    private String grpname;//工作组名称

    @Excel(name = "执行机构",sort = 2)
