 ...
 * @date 2021-01-12
 */
public class SmBizTaskinfoTwo implements Serializable
{
    ...
    private String schedulingName;//计划单标题
    ...
    @Excel(name = "执行工作组",sort = 4)
    private String grpname;//工作组名称

    @Excel(name = "执行机构",sort = 5)
