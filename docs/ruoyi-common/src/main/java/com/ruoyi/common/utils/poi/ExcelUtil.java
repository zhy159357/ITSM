...
public class ExcelUtil<T>
{
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        {
            // 设置行高
            row.setHeight((short) (attr.height() * 40));
            ...
            if (attr.isExport())
            {
                ...
                // 去除数据库clob字段中的<p></p><br></br>等标签
                if(StringUtils.isNotNull(value) && value instanceof String) {
                    value = value.toString().replace("<p>", "").replace("</p>", "").
    ...
    {
        return DictUtils.getPubParaValueDetail(dictType, dictValue, separator);
    }
    ...
    {
        return DictUtils.getPubParaValue(dictType, dictLabel, separator);
    }
