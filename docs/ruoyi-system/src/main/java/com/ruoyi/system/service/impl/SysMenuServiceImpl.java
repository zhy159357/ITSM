...
public class SysMenuServiceImpl implements ISysMenuService
{
     ...
     */
    @Override
    public List<SysMenu> selectMenusByUser(OgUser user)
    {
...
//        }
     ...
     */
    @Override
    public List<Ztree> roleMenuTreeData(OgRole role, String userId)
    {
    ...
    public List<Ztree> initZtree(List<SysMenu> menuList, List<String> roleMenuList, boolean permsFlag)
    {
        ...
        for (SysMenu menu : menuList)
        {
            ...
            if (isCheck)
            {
                ztree.setChecked(roleMenuList.contains(menu.getMenuId().toString()));
            }
            ztrees.add(ztree);
        }
        return ztrees;
    ...
    public int insertMenu(SysMenu menu)
    {
        if("mysql".equals(dbType)){
            return menuMapper.insertMenuMysql(menu);
        }else{
    ...
    {
        if("mysql".equals(dbType)){
            return menuMapper.updateMenuMysql(menu);
        }else{
