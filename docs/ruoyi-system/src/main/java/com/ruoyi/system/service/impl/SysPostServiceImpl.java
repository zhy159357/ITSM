...
public class SysPostServiceImpl implements ISysPostService
{
     ...
     */
    @Override
    public int insertAuthRoles(String postId, String rIds) {
        String[] roles = Convert.toStrArray(rIds);
        //新增岗位与角色管理
        List<OgRolePost> list = new ArrayList<OgRolePost>();
        ...
        return rolePostMapper.batchPostRole(list);
    }
